...
// const ShopItem = ({ params }: { params: { itemId: string } }) => {
//   const itemId = parseInt(params.itemId, 10); // Ensure itemId is a number

//   // Check if itemId is within the bounds of the products array
